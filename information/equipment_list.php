<div class="container">
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<p>A mobile phone is listed here, even though you may not be able to
				get phone reception at any point in the race, but it may work on the
				highest points, or if you have to make an emergency exit to a road
				end and need to call for help. Additionally, many modern mobile
				phones contain GPS receivers which may be useful for navigation in
				an emergency.
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<ul class="list-group">
						...
						<li class="list-group-item">First aid kit containing the
							following:<br />
							<ul>
								<li>Pain Killers
