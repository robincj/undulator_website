	...
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<h2>
				...
				<h2>
					<h3>START</h3>
					Start at Mangatoetoe river end to Kawakawa Hut. Follow river
					upstream.<br /> After 4km (30 mins ish) the river splits around an
					...
					<h3>UNDULATION #1</h3>
					Approx. 130m vertical climb. Steep climb, sidle over saddle, then
					very steep descent, TAKE CARE. Descent ends by waterfall and pool –
					follow river down stream, rocky boulder hopping for 4km. <br />At
					that 4km point make sure you scanning the right of river as there
					will be abig DOC triangle marking where you leave the river bed.
					You must spot this or you will miss the turn off and head down the
					river. The triangle leads you into acopse of trees and a track that
					leads to <b>Kawakawa Hut</b>.

					<h3>KAWAKAWA HUT</h3>
					Kawakawa Hut is on true right of river, and marshalled. A 4WD track
					crosses river at hut. You MUST GET CHECKED BY MARSHAL at the hut.<br />
					Kawakawa hut to Pararaki HutHead upstream crossing creek regularly
					for 10 to 15 mins. Turn left at ‘Pararaki Hut’ wooden sign.


					<h3>UNDULATION #2</h3>
					Approx. 310m vertical climb. Steep climb up narrow ridge – careful,
					don’t fall off. Long cambered sidle to saddle. <br /> When you hit
					the BIG fallen log look hard left for the track not straight ahead.
					<br />After saddle descend to Pararaki river. <br />Turn right
					upstream at river.

					<h3>PARARAKI HUT</h3>
					<b>Pararaki hut</b> is 100m upstream on left (true right).<br />
					YOU MUST GET CHECKED BY MARSHAL at the hut. Pararaki hut to
					Washpool hut


					<h3>UNDULATION #3</h3>
					Approx. 550m vertical climb. Windfall at base of track not far from
					hut, follow orange taps and markers. Solid climb, obvious track.<br />
					Then very steep descent ending in a final 30 or so metres of loose
					scree, very easy to gather unwanted / wanted momentum. <br /> Turn
					left at Washpool stream and follow blazes downstream for 100m, look
					for sign to hut on true right bank and head up steps to <b>Washpool
						hut</b>.
					...
					towards NW ridge.<br /> Ridge undulates for 3km through bush. When
					you get to old fence and 4x4 track it is pretty much the climbing
					over.<br /> Descend through ‘Gorse Alley’ – like taking off a
					plaster this is best done quickly, showing weakness will be booed.<br />
					Take signed (and marshalled) left turn to Pinnacles – YOU MUST
					CHECK IN WITH MARSHAL.<br /> Turn left to lookout track NOT
					‘Circular Walk’ and descend obvious stepped route to river valley.<br />
					Turn right at river valley and follow river downstream towards
					aromas of sausages sizzling and rest awaiting.<br /> Look out for
					BLUE WARATAHS WITH ORANGE TRIANGLES. There are 2 and will put you
					on the track to the finish. If you miss them it’s not a major
					you’ll just be running on rougher terrain and it will take longer.<br />
					You’re done.
