...
<div class="A100" role="tabpanel">
	...
	<div id="course_notes" class="tab-content">
		<div role="tabpanel" class="tab-pane fade" id="coursenotes_day1">
			<?php include('A100_day_1.php');?>
		</div>
		<div role="tabpanel" class="tab-pane fade" id="coursenotes_day2"><?php include('AU.php'); ?></div>
		<div role="tabpanel" class="tab-pane fade" id="coursenotes_day3"><?php include('A100_day_3.php'); ?></div>
